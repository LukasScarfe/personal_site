...
date: 2025-02-24
description: "Demonstrating real-time wavefront correction using fast Adaptive Optics to enable secure high-dimensional QKD in turbulent channels."
summary: "We employ a high-speed Adaptive Optics (AO) system to correct real-time wavefront distortions in spatial modes, significantly reducing crosstalk and error rates for OAM-based QKD in turbulent environments."
tags: ["Quantum Key Distribution", "Adaptive Optics", "Orbital Angular Momentum", "Atmospheric Optics"]
categories: ["Research"]
showSummary: true
showAuthor: false
showDate: true
